...
for c, geo in it.product(clusters, opt_instance.geos):
    ...
    model.add_constr(mip.xsum([z[(c,g1.id,g2.id)] for g1,g2 in it.combinations(opt_instance.geos,2) if g1==geo or g2==geo ]) <= ft_has_geo[(c,geo.id)], 
                     name=f'cod_z_min_bound_g1_{c}_{g1}_{g2}') 
